...
for snr =begin_snr:end_snr
    ...
    load(strcat('../CNN_samples/',fdata,'_20.mat'))
...
tic
disp(strcat('start saving', 32,file_name,'_20.mat, please wait....'))
toc

tic

save(strcat('../CNN_samples/',file_name,'_20'),'train_x','train_y','test_x','test_y','-v7.3')
