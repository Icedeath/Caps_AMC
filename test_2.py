# -*- coding: utf-8 -*-
"""
Created on Mon Apr  8 10:04:51 2019
...
if __name__ == "__main__":
    ...
    for s in snr:
        ...
        print('Evaluating...')
        idx_cm = get_cm(y_train, y_pred1, args)
        acc1 = get_accuracy(idx_cm)
     
        pm1 = np.sum(idx_cm[args.num_classes,:])/(np.sum(
    ...
    sio.savemat('acc.mat', {'acc':acc, 'acc_aver':acc_aver, 'pf':pf, 'pm': pm})
